...
const StaffCreationForm = (props) => {
    ...
    const handleSubmit = (e) => {
      e.preventDefault();
      const post_api_url = 'http://localhost:5000/api/create_staff'
    ...
    return (
      <>
        <h1>Create Staff</h1>
        <form name='StaffCreationForm' id='StaffCreationForm' onSubmit={handleSubmit} autoComplete='on'>
          <IRow>
            <ICol>
